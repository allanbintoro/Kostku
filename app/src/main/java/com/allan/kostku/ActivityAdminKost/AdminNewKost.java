...
public class AdminNewKost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_new_kost);
        initToolbar();
        ui();
        ...
        storageTask = storageReference.putFile(uri1)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AdminNewKost.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void addNewKost() {
        ...
        if (kostName.isEmpty()) {
            ...
            kostData.put("kostOwnerId", ResourceManager.LOGGED_USER.getUserId());
            ...
            kostRef.document(kostId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(AdminNewKost.this, "Success Add New Kost", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(AdminNewKost.this, AdminKost.class));
                        }
                    });
        }
    }
