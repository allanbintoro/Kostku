...
public class MasterNewRoom extends AppCompatActivity {
    //Image
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_master_new_room);
        ...
        storageTask = storageReference.putFile(uri1)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MasterNewRoom.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
            ...
            kostRef.document(kostId).collection("Room").document(roomId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(MasterNewRoom.this, "Success Add New Room", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
        }
