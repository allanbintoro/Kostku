...
import com.allan.kostku.Model.RoomImage2;
...
public class MasterEditRoom extends AppCompatActivity {
    //Image
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_master_edit_room);
        ...
        storageTask = storageReference.putFile(uri1)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MasterEditRoom.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void uploadImage2(final Uri uri2) {
        final RoomImage2 roomImage = new RoomImage2();
        //Image Bathroom Ref
                ...
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        if (uri2.equals(uri2)) {
                            if (room.getRoomImage() != null) {
                               if(uri1 == null) {
                                    roomImage.setRoomImage2(room.getRoomImage());
                                }
                            }
                            roomImage.setBathroomImage2(downloadUrl.toString());
                            kostRef.document(kostId).collection("Room").document(roomId).set(roomImage, SetOptions.merge());
                        }
                    }
                })
            ...
            kostRef.document(kostId).collection("Room").document(roomId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(MasterEditRoom.this, "Success Update Room", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent();
