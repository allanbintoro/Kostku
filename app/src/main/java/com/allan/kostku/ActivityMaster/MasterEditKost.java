...
public class MasterEditKost extends AppCompatActivity {
    //Image
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_master_edit_kost);
        initToolbar();
            ...
            kostRef.document(kostId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(MasterEditKost.this, "Success Update Kost", Toast.LENGTH_SHORT).show();
        ...
        storageTask = storageReference.putFile(uri1)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MasterEditKost.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
