...
import com.allan.kostku.ActivityUser.ReportDataUser;
...
public class UserReportAdapter extends RecyclerView.Adapter<UserReportAdapter.MyViewHolder> {
    ...
    public UserReportAdapter(ArrayList<Report> list, Context context) {
        this.list = list;
...
//        myViewHolder.tv_date.setText(DateFormat.getDateInstance(DateFormat.DEFAULT).format(list.get(i).getTimestampCreatedLong()));
        myViewHolder.listItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, ReportDataUser.class);
